...
def function5():
    ...
    z = np.zeros(20, np.int32).reshape(4, 5) #wrtie your code here
...
def function8():
    ...
    x = np.full((2, 5), 6, np.uint) #write your code here
...
def function10():
    ...
    subt = np.empty_like(arr) # write your code here 
    n0, n1 = np.shape(arr)
    for i in range(n0):
        subt[i] = arr[i] - brr[i]
        i += 1
...
def function11():
    ...
    ans = np.copy(arr) #write your code here
    ans[ans % 2 != 0] = -1 
...
def function14():
    ...
    ans = np.split(arr, [2, 4,6]) #write your code here 
...
def function18():
    ...
    x = len(np.intersect1d(students, piaic)) # Write you code Here
    return x
...
def function19():
    ...
    W =  X.copy().swapaxes(0, 1) # Write your code here 
